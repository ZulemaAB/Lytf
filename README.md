...
Para este ejercicio debemos de realizar nuestra estructura de html en un principio, cabe mencionar que lo devidiremos(html) por secciones para poder manejarlo adecuadamente.
...
Para el formulario, las etiquetas como form e input.
